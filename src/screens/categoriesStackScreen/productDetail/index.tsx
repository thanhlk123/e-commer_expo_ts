...
const ProductSize = (props) => {
  return (
    <View style={{ flexDirection: "row", alignItems: "center" }}>
      <Text style={{ fontSize: 20, fontWeight: "400", paddingBottom: 3 }}>
        Size:
      </Text>
      {ListOfSize.map((data, index) =>
        props.sizeSelected === index ? (
          <View>
            <TouchableOpacity onPress={() => props.onPressX(index)}>
              <View
                style={{
                  marginHorizontal: 5,
                  width: 30,
      ...
      {ListOfCustomerComment.map((data) => (
        ...
        >
          ...
          <View style={{ flex: 1, margin: 5 }}>
            ...
            <View style={{ margin: 5 }}>
              <Text>
                E chào cô. Do một số lý do gì đó mà tài khoản của e không được
                quét nộp tiền học. Cô cho e hỏi giờ e làm sao ạ. Vì mai e thi mà
                kiểm tra thấy tài khoản vẫn còn tiền ạ
              </Text>
            </View>
            ...
            <View style={{ backgroundColor: "#e6e7e8", padding: 5 }}>
              ...
              <Text style={{ fontSize: 13 }}>Shop cảm ơn bạn nhé!</Text>
            </View>
          </View>
        </View>
      ))}
    ...
    return (
      <>
        ...
        <SafeAreaView style={[styles.container]}>
          ...
          >
            <HeaderComponent title={"Product Detail"} icLeft="back" onPressLeft = {() => this.props.navigation.goBack()}/>
            <ScrollView
            ...
            >
              ...
              <View style={styles.mb_10}>
                <View style={{ flexDirection: "row" }}>
                  <Text style={styles.similarProductText}>
                    Sản phẩm tương tự
                  </Text>
                  <TouchableOpacity style={{ width: 100 }}>
                    <Text style={styles.seeAllText}>
                      Xem tất cả{" "}
                      <AntDesign name="right" size={14} color="red" />
                    </Text>
                  </TouchableOpacity>
                </View>
