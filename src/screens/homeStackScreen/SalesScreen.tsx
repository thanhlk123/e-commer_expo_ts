...
const RenderSalesShop = (props) => {
  return (
    <TouchableOpacity
      ...
      onPress={() => {
        props.navigation.navigate("Categories", { screen: "ListCategories" });
      }}
    >
      <Image
        source={props.imgUrl}
      ...
      {props.data.map((programs) => {
        return (
          <TouchableOpacity
            key={programs.imgUrl}
            style={[
              styles.salesPropgramContainer,
              styles.shadowStyleProgramItem,
            ]}
            onPress={() => {
...
export default class SalesScreen extends Component<{ navigation: any }, {}> {
  constructor(props) {
    super(props);
    this.state = {};
  }
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            <View style={{ marginBottom: 30 }}>
              ...
              <View style={styles.centerItem}>
                <Text style={styles.salesTextTitle}>
                  ---Last Chance of Stock Up---
                </Text>
              </View>
              <RenderSalesProgram
                data={salesProgramData}
                navigation={this.props.navigation}
              />
