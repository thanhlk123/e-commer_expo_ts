...
> {
  _handleGoogleLogin = async () => {
    try {
      const { type, user, idToken, accessToken }: any = await Google.logInAsync(
        {
          androidStandaloneAppClientId:
            "208098970743-e8442r8frk3vhbcjja5jg4fqa0ivn326.apps.googleusercontent.com",
      ...
      switch (type) {
        ...
        case "cancel": {
          Alert.alert("Tính năng đang bảo trì. Vui lòng thử lại sau");
          break;
        }
        default: {
          Alert.alert("Tính năng đang bảo trì. Vui lòng thử lại sau");
