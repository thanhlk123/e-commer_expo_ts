            ...
            >
              ...
              <View style={{ alignItems: "center" }}>
                <ItemOfTopic
                  ...
                  itemContent="Theo dõi đơn hàng"
                />

                <ItemOfTopic
                  typeVector="AntDesign"
                  nameVector="clockcircleo"
                  itemContent="Đơn hàng dịch vụ tiện ích"
                />

                <ItemOfTopic
                  typeVector="FontAwesome"
                  nameVector="money"
                  itemContent="Theo dõi khoản vay"
                />

                <ItemOfTopic
                  typeVector="AntDesign"
                  nameVector="staro"
                  itemContent="Đánh giá của tôi"
                />

                <ItemOfTopic
                  typeVector="Entypo"
                  nameVector="location"
                  itemContent="Thông tin nhận hàng"
                />

                <ItemOfTopic
                  typeVector="Entypo"
                  nameVector="wallet"
                  itemContent="Tài khoản Payment"
                />

                <ItemOfTopic
                  typeVector="AntDesign"
                  nameVector="creditcard"
                  itemContent="Thẻ và tài khoản liên kết"
                />

                <ItemOfTopic
                  typeVector="AntDesign"
                  nameVector="setting"
                  itemContent="Cài đặt thông báo"
                />
              </View>
            </View>
            ...
            >
              ...
              <View style={{ alignItems: "center" }}>
                <ItemOfTopic
                  typeVector="Entypo"
                  nameVector="shop"
                  itemContent="Bán hàng cùng Sendo"
                />
              </View>
            </View>
